...
std::vector<exoIISideSet> automaticSidesetFinder ( std::vector< exoIIElement > *allElements, int minimumSSTag, int maximumSSTag, std::vector< exoIIElement > sidesetElements, int threads);
